...
| exp | 0.093135 | 0.013373 | 0.96 | 0.53696 |
| power | 0.096264 | 0.011528 | 0.96043 | 0.22144 |
| linear | 0.094102 | 0.013438 | 0.95955 | 0.67188 |
...
参数、数据弹性和质量半弹性已保存于 `marginal_elasticities.csv`。在 B6 支持网格内，Q 提升 0.1 的参数等价倍数中位数为 1.219；每个网格点均给出轨迹/单元 Bootstrap 区间和有效抽样比例。该数值是固定 D、固定配比、采用 B6 原生 Q 标尺时的条件等价量，不能脱离基准 N、D、Q 使用。问题一 Q 与 B6 Q 无成对标定，`quality_scale_sensitivity.csv` 另给出 $b_Q=0.5,1,1.5$ 的标尺敏感性。
