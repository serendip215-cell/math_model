...
要求 XeLaTeX、ctex 及 Windows 的宋体/黑体字体。当前工作环境未检测到 xelatex、latexmk 或 tectonic，因此**尚未生成整篇论文 PDF，也尚未完成编译与版面验收**。已核对全部章节和插图路径存在；关键插图 PDF 可由 Poppler 解析。
...
- 正式提交前须逐式逐表复核、编译检查分页、填写真实团队信息并按当届赛制处理封面。文末已披露 AI 工具参与范围。
